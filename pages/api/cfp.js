...
const schema = joi.object({
  ...
  talkHashtags: joi.string().pattern(/(?:#[a-zA-Z0-9_\-$]+(?:\s|$))+$/).required()
    .messages({
  ...
  talkSummary: joi.string().min(10).required()
    .messages({
